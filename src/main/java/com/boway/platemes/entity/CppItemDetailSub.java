...
@Entity
@Table ( name ="CPP_ITEM_DETAIL_SUB" , schema = "")
public class CppItemDetailSub  implements Serializable {

	private static final long serialVersionUID =  9177548007563510501L;
