...
@Entity
@Table ( name ="CPP_ITEM_DETAIL_BACK" , schema = "")
public class CppItemDetailBack  implements Serializable {

	private static final long serialVersionUID =  1160766699225633914L;
