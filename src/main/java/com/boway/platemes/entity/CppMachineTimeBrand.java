...
@Entity
@Table ( name ="CPP_MACHINE_TIME_BRAND" , schema = "")
public class CppMachineTimeBrand  implements Serializable {

	private static final long serialVersionUID =  4615015526616892509L;
