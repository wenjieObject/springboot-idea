...
@Entity
@Table ( name ="CPP_ITEM_DETAIL_copy1" , schema = "")
public class CppItemDetailCopy1  implements Serializable {

	private static final long serialVersionUID =  2012000166696672183L;
