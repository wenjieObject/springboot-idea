...
@Entity
@Table ( name ="CPP_SIMULATION_ORDER" , schema = "")
public class CppSimulationOrder  implements Serializable {

	private static final long serialVersionUID =  2048108651389620288L;
