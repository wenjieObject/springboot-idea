...
@Entity
@Table ( name ="SSD_DEPARTMENT_USER" , schema = "")
public class SsdDepartmentUser  implements Serializable {

	private static final long serialVersionUID =  4901419355808517625L;
